    ...
    >
      <div class="text-center">
        ...
        <div class="flex items-center justify-center">
          <h1 ref="typewriterText" class="text-[21px] sm:text-4xl lg:text-5xl  font-semibold text-[#343A40]"></h1>
          <span ref="cursor" class="text-[21px] sm:text-4xl lg:text-5xl font-semibold text-[#343A40] ml-1">|</span>
        </div>
      </div>
    </div>
  </div>
