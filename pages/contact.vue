<template>
    <div class="grid lg:grid-cols-[300px_1fr]  md:grid-cols-[200px_1fr] lg:mx-4 grid-cols-1 px-2 md:px-0 mb-32  height-3xl:mt-[5.5%]   "> 
    ...
    <div class="flex flex-wrap items-baseline md:gap-2 lg:gap-2 leading-relaxed border-b-1 border-b-[#1B263B]/20 pb-8">
      ...
      <input 
        ...
        class="bg-transparent border-0 border-b-2 text-lg border-black/40 text-black    lg:text-3xl font-medium px-0 py-2 outline-none placeholder:text-sm placeholder:xl:text-xl placeholder:lg:text-lg placeholder:md:text-sm tracking-wide placeholder-[#9DA0A6]  focus:border-black max-w-100 flex-1 mr-4"
      />
      ...
      <input 
        ...
        class="bg-transparent border-0 border-b-2 border-black/40 text-black font-medium text-lg xl:text-3xl  px-0 py-1 md:py-2 outline-none pt-3 placeholder:text-sm placeholder:md:text-sm placeholder:lg:text-lg placeholder:xl:text-xl tracking-wide placeholder-[#9DA0A6]  focus:border-black w-60  sm:max-w-130 flex-1 mr-4"
      />
